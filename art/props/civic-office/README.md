# civic-office · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/civic-office/background.png)：1536 ×
  1024 空背景。移除盆栽、中央时钟终端、桌椅及地毯、南侧终端与柜台小物；保留固定服务柜台和出口。
- [`layout.json`](../../../public/assets/civic-office/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/civic-office.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/civic-office/`。

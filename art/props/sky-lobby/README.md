...
- [`background.png`](../../../public/assets/sky-lobby/background.png)：1536 ×
  1024 空背景。移除接待台、展台、指示牌、沙发及独立盆栽；保留电梯门和南侧入口。
- [`layout.json`](../../../public/assets/sky-lobby/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/sky-lobby.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/sky-lobby/`。

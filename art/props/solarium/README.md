...
- [`background.png`](../../../public/assets/solarium/background.png)：1536 ×
  1024 空背景。移除接待台、玻璃展台、长凳与通道盆栽；保留建筑、固定花坛、树木、步道和电梯。
- [`layout.json`](../../../public/assets/solarium/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/solarium.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/solarium/`。

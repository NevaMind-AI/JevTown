# embers-lounge · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/embers-lounge/background.png)：1536 ×
  1024 空背景。移除牌桌、沙发、酒柜、桌椅、地毯和盆栽；保留木地板、壁灯与右侧出口。
- [`layout.json`](../../../public/assets/embers-lounge/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/embers-lounge.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/embers-lounge/`。

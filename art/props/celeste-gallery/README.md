# celeste-gallery · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/celeste-gallery/background.png)：1536 ×
  1024 空背景。移除六座展柜、书柜、矮柜、阅读台、长地毯和盆栽；保留窗户、门阶与固定装饰。
- [`layout.json`](../../../public/assets/celeste-gallery/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/celeste-gallery.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/celeste-gallery/`。

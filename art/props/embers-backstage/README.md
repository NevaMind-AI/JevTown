# embers-backstage · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/embers-backstage/background.png)：1536 ×
  1024 空背景。移除梳妆台及镜子、衣架、行李、沙发、地毯和盆栽；保留门口和固定壁灯。
- [`layout.json`](../../../public/assets/embers-backstage/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/embers-backstage.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/embers-backstage/`。

# celeste-archive · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/celeste-archive/background.png)：1536 ×
  1024 空背景。移除书架、展柜、书桌、仪器工作台与盆栽；保留窗户、壁灯和南侧出口。
- [`layout.json`](../../../public/assets/celeste-archive/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/celeste-archive.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/celeste-archive/`。

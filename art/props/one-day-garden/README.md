# one-day-garden · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/one-day-garden/background.png)：1536 ×
  1024 空背景。移除园艺桌、工具容器、说明画架和独立盆栽；保留四块种植床、灌溉管线、阶梯与电梯。
- [`layout.json`](../../../public/assets/one-day-garden/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/one-day-garden.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/one-day-garden/`。

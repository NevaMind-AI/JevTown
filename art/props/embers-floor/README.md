# embers-floor · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/embers-floor/background.png)：1536 ×
  1024 空背景。移除牌桌、沙发、吧台、终端、保险柜、盆栽及舞台器材；保留舞台建筑、幕布和满铺地毯。
- [`layout.json`](../../../public/assets/embers-floor/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/embers-floor.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/embers-floor/`。

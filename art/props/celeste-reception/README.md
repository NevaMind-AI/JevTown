# celeste-reception · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/celeste-reception/background.png)：1536 ×
  1024 空背景。移除沙发、桌椅、长凳、地毯、陈列矮柜与盆栽；保留窗户和固定藤蔓。
- [`layout.json`](../../../public/assets/celeste-reception/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/celeste-reception.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/celeste-reception/`。

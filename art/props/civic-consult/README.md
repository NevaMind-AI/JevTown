# civic-consult · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/civic-consult/background.png)：1536 ×
  1024 空背景。移除咨询桌椅、终端、档案柜、地毯、独立时钟台与盆栽；保留门口、证书与地面纹样。
- [`layout.json`](../../../public/assets/civic-consult/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/civic-consult.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/civic-consult/`。

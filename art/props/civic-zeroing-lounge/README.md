# civic-zeroing-lounge · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/civic-zeroing-lounge/background.png)：1536 ×
  1024 空背景。移除沙发、扶手椅、茶几、饮水机、地毯与盆栽；保留全景窗和右侧出口。
- [`layout.json`](../../../public/assets/civic-zeroing-lounge/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/civic-zeroing-lounge.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/civic-zeroing-lounge/`。

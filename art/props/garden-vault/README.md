# garden-vault · 房间底图与布局

![原始布局](room-layout.png)

- [`background.png`](../../../public/assets/garden-vault/background.png)：1536 ×
  1024 空背景。移除书柜、工作台、凳子、晶体展台及盆栽；保留固定管线设备、楼梯和地面嵌纹。
- [`layout.json`](../../../public/assets/garden-vault/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/garden-vault.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/garden-vault/`。

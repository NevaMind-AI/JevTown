...
- [`background.png`](../../../public/assets/noel-suite/background.png)：1536 ×
  1024 空背景。移除床、床头柜、音响柜、桌椅、沙发、地毯和盆栽；保留木地板、窗户及入口。
- [`layout.json`](../../../public/assets/noel-suite/layout.json)：`sourceLayout`
...
来源：`project-myrmidon-map-prototype/source/imagegen-v2/assets/maps/noel-suite.png` 与
`source/imagegen-v2/world.json`。制作提示词、候选、修补遮罩和对照图保存在本地
`art/map-study/noel-suite/`。

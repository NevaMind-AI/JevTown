...
import CenterOnPlayerButton from './buttons/CenterOnPlayerButton.tsx';
    ...
    <>
      ...
      <div className="mx-auto w-full max-w grid grid-rows-[240px_1fr] lg:grid-rows-[1fr] lg:grid-cols-[1fr_auto] lg:grow max-w-[1400px] min-h-[720px] max-h-[720px] game-frame">
        ...
        <div className="relative overflow-hidden bg-brown-900" ref={gameWrapperRef}>
          {/* Floating in-game controls, top-left inside the game frame. */}
          <div className="absolute top-0 left-0 z-10 flex flex-col items-start gap-3 p-4 pointer-events-none origin-top-left scale-[0.8]">
            <FreezeButton />
            <MusicButton />
            <InteractButton />
            <CenterOnPlayerButton worldId={worldId} game={game} viewportRef={viewportRef} />
          </div>

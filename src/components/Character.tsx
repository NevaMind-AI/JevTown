...
export const Character = ({
  ...
  // Preserve fractional frame progress across short tile steps. The declarative
  // isPlaying toggle calls gotoAndPlay(0), resetting before a walking frame appears.
  const ref = useRef<PIXI.AnimatedSprite | null>(null);
  useEffect(() => {
    if (isMoving) ref.current?.play();
    else ref.current?.stop();
  }, [direction, isMoving, spriteSheet]);

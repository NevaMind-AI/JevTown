...
function generate_preamble() {
  const mapfile_preamble =
    ...
    g_ctx.tilesetpath +
    '"\n' +
    'export const tiledim = ' +
    g_ctx.tiledimx +
    '\n' +
    'export const screenxtiles = ' +
    g_ctx.tilesettilew +
    '\n' +
    'export const screenytiles = ' +
    g_ctx.tilesettileh +
    '\n' +
    'export const tilesetpxw = ' +
    g_ctx.tilesetpxw +
    '\n' +
    'export const tilesetpxh = ' +
    g_ctx.tilesetpxh +
    '\n\n';
...
const bgtile_string_start = '' + 'export const bgtiles = [\n' + '   [\n';
...
function write_map_file(bg_tiles_0, bg_tiles_1, obj_tiles_1, obj_tiles_2, animated_tiles) {
  ...
  for (let x = 0; x < animated_tiles.length; x++) {
    ...
    text +=
      ', sheet: "' + atile.spritesheetname + '", animation: "' + atile.animationname + '" },\n';
  }
...
export function generate_level_file() {
  ...
  // level0
  var tile_array0 = Array.from(
    Array(CONFIG.leveltilewidth),
    () => new Array(CONFIG.leveltileheight),
  );
